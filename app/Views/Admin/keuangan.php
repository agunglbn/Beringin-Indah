    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
            ...
            <div class="card-box mb-30">
                <div class="pd-20">
                    <h4 class="text-blue h4">Data Khas</h4>
                    <p class="mb-0">
                    ...
                    <table class="data-table table stripe hover nowrap table-bordered">
                        ...
                        <thead>
                            <tr class="text-center">
                                ...
                                <th width="5px">Nama</th>
                                <th width="9px">Deksripsi</th>
                                <th width="5px">Nominal</th>
                                <th width="5px">Tanggal</th>
                                <th width="5px">Status</th>
                                <th width="5px" class="datatable-nosort">Action</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php $i = 1; ?>
                                        ...
                                        <div class="modal-dialog modal-sm">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form
                                                        action="<?php echo base_url('admin/updateStatusBerita/' . $khas['id']) ?>"
                                                        method="POST">
                                                        <?= csrf_field() ?>
            ...
            <div class="modal fade" id="tambah-khas" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="<?= base_url('/admin/TambahKhas'); ?>" enctype="multipart/form-data"
                                method="post">
                                <?= csrf_field() ?>
                                ...
                                <div class="input-group custom">
                                    ...
                                    <div class="input-group-append custom">
                                        <span class="input-group-text"><i
                                                class="icon-copy fi-list-thumbnails"></i></span>
                                    </div>
                                ...
                                <div class="input-group custom">
                                    <input name="nominal" type="number" value="" id=""
